...
>
	<h2 class="pb-2 text-2xl font-bold">What is the code of conduct?</h2>
	<p class="text-sm">
		SwampHacks follows the recommended code of conduct published by MLH which can be found <a
			class="text-sapphire underline"
			href="https://bit.ly/4eXbbDe"
