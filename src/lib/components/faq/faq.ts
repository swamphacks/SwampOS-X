...
export const faq: Record<string, QA[]> = {
	General: [
		...
		},
		{
			...
			answer:
				'No coding experience is necessary! We welcome participants of all skill levels. Workshops and mentors will be available to help you throughout the event.'
		},
		{
	...
	'Rules & Day of Event': [
		...
		},
		{
			...
			answer:
				'All hackers are required to follow the MLH Code of Conduct which can be found at https://bit.ly/4eXbbDe'
		}
	],
	'Venue & Food': [
		{
