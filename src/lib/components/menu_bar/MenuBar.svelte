<section
	class="flex h-[30px] w-screen items-center border-y-2 border-solid border-b-[#BBBBBB] border-t-[#EEEEEE] bg-[#DDDDDD] px-[8px] font-chicago text-[13px] leading-[2]"
>
	...
	<div class="flex grow flex-row-reverse items-center">
		...
		/>
		<button class="px-2">12:45 PM</button>
	</div>
</section>
<span class="block h-[2px] w-screen bg-[#262626]" />

<style lang="postcss">
	.btn-container {
		@apply flex h-[34px] items-center px-2 hover:bg-[#333399];
	}
</style>
